...
public class EuclideanDistance implements Distance{
     ...
     * <p>
     * This reads both vectors from index 0. A variant taking an offset into each existed while the
     * points of the ball tree were views of the flat input matrix; it was measurably slower in the
     * innermost loop of the search and went with them, see {@link DataPoint}.
     *
